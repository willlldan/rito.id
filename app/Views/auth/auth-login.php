                ...
                <form method="POST" action="<?= route_to('login') ?>" class="needs-validation" novalidate="">
                  ...
                  <?php if ($config->validFields === ['email']) : ?>
                    <div class="form-group">
                      ...
                      <input id="email" type="email" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" tabindex="1" placeholder="<?= lang('Auth.email') ?>" required autofocus>
                  ...
                  <?php else : ?>
                    <div class="form-group">
                      ...
                      <input id="email" type="text" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" tabindex="1" placeholder="<?= lang('Auth.emailOrUsername') ?>" required autofocus>
                      <div class="invalid-feedback">
                        <?= session('errors.login') ?>
                      </div>
                    </div>
